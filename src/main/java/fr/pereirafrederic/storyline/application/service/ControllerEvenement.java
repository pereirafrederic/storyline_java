...
public class ControllerEvenement {
	...
	public Evenement recupererEvenement(
			@PathVariable(value = "id") Long id, @PathVariable(value = "idUser") Long idUser) throws Exception {
	...
	public List<Evenement> recupererEvenement(@PathVariable(value = "idUser") Long idUser,
			@PathVariable(value = "idTemps") Long idTemps, @PathVariable(value = "idEspace") Long idEspace) throws Exception {
